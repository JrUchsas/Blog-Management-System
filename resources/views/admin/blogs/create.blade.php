...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800 font-weight-bold" style="font-weight: 700;">Add Blog Post</h1>
                ...
                <form action="{{ route('admin.blogs.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="mb-3">
                                <label for="slug" class="form-label font-weight-bold">Slug (Auto-generated & Editable)</label>
                                <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" value="{{ old('slug') }}" placeholder="blog-slug" required>
                                @error('slug')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('details') is-invalid @enderror" id="details" name="details" rows="10">{{ old('details') }}</textarea>
                                @error('details')
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control @error('image') is-invalid @enderror" id="image" name="image" accept=".jpeg,.jpg,.png,.webp" required>
                                <div class="form-text">Supported: JPG, JPEG, PNG, WebP. Max size: 2 MB.</div>
                                @error('image')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                                
                                <div class="image-preview-container d-none" id="image-preview-wrapper">
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        ...
                        <button type="submit" class="btn btn-primary" style="padding: 12px 20px;">Save Blog Post</button>
                    </div>
                </form>
            </div>
        </div>
